...
sortByRate(movies);
// // 4. Создать новый массив, где объекты фильмов будут состоять из следующих полей: id, title, released, plot
// function newMovies(arr: Partial<Movie>[]) {
...
//   const newArr = arr.filter((item) => {
//     return (
//       item.hasOwnProperty(nameOfField) &&
//       Object.values(item).includes(value) &&
//       Object.keys(item).map((key) => key === nameOfField) ===
//         Object.values(item).map((val) => val === value)
//     );
//   });
//   console.log(newArr);
// }
